  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setCurrentBackground(
        sections[maxVisibleSection.id as keyof typeof sections].color
      );
    ...
    <LoaderScreen>
      <div className="overflow-hidden">
        ...
        >
          <div
            ref={(el) => {
              if (el) sectionRefs.current.tracks = el;
            }}
          >
          ...
          <div
            ref={(el) => {
              if (el) sectionRefs.current.sponsors = el;
            }}
          >
            <Sponsors />
          </div>
          ...
          {/* <div
            ref={(el) => {
              if (el) sectionRefs.current.prizes = el;
            }}
          >
            <Prizes />
          </div> */}
