...
const FaqDialog = ({ isOpen, onClose, content }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#4B5862] bg-opacity-70 backdrop-blur-sm lg:hidden">
      <div className="relative bg-[#125A76] border-4 border-[#FFCE00] text-white font-semibold p-6 rounded-lg shadow-lg w-[90%] max-w-md flex flex-col items-center">
        {/* Dots at corners */}
        ...
        <button
          onClick={onClose}
          className="bg-[#FFCE00] text-[#125A76] font-bold py-2 px-6 rounded-lg hover:bg-[#e6b800]"
        >
          Close
        </button>
      </div>
