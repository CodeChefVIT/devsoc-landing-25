...
const AnimatedTimeline = () => {
  ...
  const timelineWidth = typeof window !== "undefined" ? window.innerWidth * 0.8 : 800;
  const dotSpacing = timelineWidth / (events.length - 1);
  const extraScrollSpace = dotSpacing * 1.5;
  ...
  const cloudImageUrl = nightMode ? "/assets/Cloudsblack.svg" : "/assets/clouds.svg";
                  ...
                  <motion.h1
                   ...
                   >
                    ...
                    <div className="relative flex mt-16 mb-20">
                      <motion.div
                        className="font-mono rounded-[50px] p-12 shadow-xl text-center border-8 w-[500px]"
                           style={{
                             backgroundColor: nightMode ? "rgba(255, 255, 255, 0.7)" : "white",
                               color: "black",
                                 ...
                                 >
                                   <motion.div
                                       className="timeline-dot w-6 h-6 rounded-full border-4 transition-colors duration-300"
                                        ...
                                        backgroundColor:
                                              nightMode
                                                   ? activeCircle === index ? "white" : "#1E1E1E"
                                                  : activeCircle === index ? "black" : "white",
                                                borderColor: nightMode ? "white" : "black",
                                              transition: 'background-color 0.5s ease-in-out, border-color 0.5s ease-in-out',
                                            }}
                                    />
